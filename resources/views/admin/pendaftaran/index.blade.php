<x-admin>
    ...
    @foreach ($pendaftar as $item)
        ...
        <div class="modal fade" id="approveModal{{ $item->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ url('admin/pendaftar/approved/' . $item->id) }}" method="POST">
                        @csrf
        ...
        <div class="modal fade" id="tolakModal{{ $item->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ url('admin/pendaftar/decline/' . $item->id) }}" method="POST">
                        @csrf
                        ...
                        <div class="modal-body">
                            <textarea name="alasan_ditolak" class="form-control"
